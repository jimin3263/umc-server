...
public class UserController {
    ...
    public UserController(UserProvider userProvider, UserService userService, JwtService jwtService, ProductProvider productProvider) {
    ...
    public BaseResponse<PostUserRes> createUser(@RequestBody PostUserReq postUserReq) {
        ...
        if (postUserReq.getPhoneNum().isEmpty() || postUserReq.getEmail().isEmpty()|| postUserReq.getPassword().isEmpty() || postUserReq.getNickname().isEmpty()) {
    ...
    public BaseResponse<List<GetProductsRes>> getProductsByUser(@PathVariable("userIdx") int userIdx,
                                                  @RequestParam(defaultValue = "active") String status){
        try {
            List<GetProductsRes> productsByUser = productProvider.getProductsByUser(userIdx, status);
            return new BaseResponse<>(productsByUser);
